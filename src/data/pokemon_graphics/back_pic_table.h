...
#endif
    SPECIES_SPRITE(STRATAGEM, gMonBackPic_Stratagem),
    SPECIES_SPRITE(VOODOOM, gMonBackPic_Voodoom),
    SPECIES_SPRITE(CARIBOLT, gMonBackPic_Caribolt),
    SPECIES_SPRITE(COLOSSOIL, gMonBackPic_Colossoil),
    SPECIES_SPRITE(CYCLOHM, gMonBackPic_Cyclohm),
    SPECIES_SPRITE(FIDGIT, gMonBackPic_Fidgit),
    SPECIES_SPRITE(KITSUNOH, gMonBackPic_Kitsunoh),
    SPECIES_SPRITE(MALACONDA, gMonBackPic_Malaconda),
    SPECIES_SPRITE(MIASMAW, gMonBackPic_Miasmaw),
    SPECIES_SPRITE(SNAELSTROM, gMonBackPic_Snaelstrom),
    SPECIES_SPRITE(SYCLANT, gMonBackPic_Syclant),
    SPECIES_SPRITE(TOMOHAWK, gMonBackPic_Tomohawk),
    SPECIES_SPRITE(REVENANKH, gMonBackPic_Revenankh),
    SPECIES_SPRITE(KRILOWATT, gMonBackPic_Krilowatt),
    SPECIES_SPRITE(CRUCIBELLE, gMonBackPic_Crucibelle),
    SPECIES_SPRITE(MOLLUX, gMonBackPic_Mollux),
    SPECIES_SPRITE(EQUILIBRA, gMonBackPic_Equilibra),
    SPECIES_SPRITE(NAVIATHAN, gMonBackPic_Naviathan),
    SPECIES_SPRITE(KERFLUFFLE, gMonBackPic_Kerfluffle),
    SPECIES_SPRITE(JUMBAO, gMonBackPic_Jumbao),
    SPECIES_SPRITE(PAJANTOM, gMonBackPic_Pajantom),
