...
#endif
    SPECIES_SHINY_PAL(STRATAGEM, gMonShinyPalette_Stratagem),
    SPECIES_SHINY_PAL(VOODOOM, gMonShinyPalette_Voodoom),
    SPECIES_SHINY_PAL(CARIBOLT, gMonShinyPalette_Caribolt),
    SPECIES_SHINY_PAL(COLOSSOIL, gMonShinyPalette_Colossoil),
    SPECIES_SHINY_PAL(CYCLOHM, gMonShinyPalette_Cyclohm),
    SPECIES_SHINY_PAL(FIDGIT, gMonShinyPalette_Fidgit),
    SPECIES_SHINY_PAL(KITSUNOH, gMonShinyPalette_Kitsunoh),
    SPECIES_SHINY_PAL(MALACONDA, gMonShinyPalette_Malaconda),
    SPECIES_SHINY_PAL(MIASMAW, gMonShinyPalette_Miasmaw),
    SPECIES_SHINY_PAL(SNAELSTROM, gMonShinyPalette_Snaelstrom),
    SPECIES_SHINY_PAL(SYCLANT, gMonShinyPalette_Syclant),
    SPECIES_SHINY_PAL(TOMOHAWK, gMonShinyPalette_Tomohawk),
    SPECIES_SHINY_PAL(REVENANKH, gMonShinyPalette_Revenankh),
    SPECIES_SHINY_PAL(KRILOWATT, gMonShinyPalette_Krilowatt),
    SPECIES_SHINY_PAL(CRUCIBELLE, gMonShinyPalette_Crucibelle),
    SPECIES_SHINY_PAL(MOLLUX, gMonShinyPalette_Mollux),
    SPECIES_SHINY_PAL(EQUILIBRA, gMonShinyPalette_Equilibra),
    SPECIES_SHINY_PAL(NAVIATHAN, gMonShinyPalette_Naviathan),
    SPECIES_SHINY_PAL(KERFLUFFLE, gMonShinyPalette_Kerfluffle),
    SPECIES_SHINY_PAL(JUMBAO, gMonShinyPalette_Jumbao),
    SPECIES_SHINY_PAL(PAJANTOM, gMonShinyPalette_Pajantom),
