...
#endif
    SPECIES_SPRITE(STRATAGEM, gMonFrontPic_Stratagem),
    SPECIES_SPRITE(VOODOOM, gMonFrontPic_Voodoom),
    SPECIES_SPRITE(CARIBOLT, gMonFrontPic_Caribolt),
    SPECIES_SPRITE(COLOSSOIL, gMonFrontPic_Colossoil),
    SPECIES_SPRITE(CYCLOHM, gMonFrontPic_Cyclohm),
    SPECIES_SPRITE(FIDGIT, gMonFrontPic_Fidgit),
    SPECIES_SPRITE(KITSUNOH, gMonFrontPic_Kitsunoh),
    SPECIES_SPRITE(MALACONDA, gMonFrontPic_Malaconda),
    SPECIES_SPRITE(MIASMAW, gMonFrontPic_Miasmaw),
    SPECIES_SPRITE(SNAELSTROM, gMonFrontPic_Snaelstrom),
    SPECIES_SPRITE(SYCLANT, gMonFrontPic_Syclant),
    SPECIES_SPRITE(TOMOHAWK, gMonFrontPic_Tomohawk),
    SPECIES_SPRITE(REVENANKH, gMonFrontPic_Revenankh),
    SPECIES_SPRITE(KRILOWATT, gMonFrontPic_Krilowatt),
    SPECIES_SPRITE(CRUCIBELLE, gMonFrontPic_Crucibelle),
    SPECIES_SPRITE(MOLLUX, gMonFrontPic_Mollux),
    SPECIES_SPRITE(EQUILIBRA, gMonFrontPic_Equilibra),
    SPECIES_SPRITE(NAVIATHAN, gMonFrontPic_Naviathan),
    SPECIES_SPRITE(KERFLUFFLE, gMonFrontPic_Kerfluffle),
    SPECIES_SPRITE(JUMBAO, gMonFrontPic_Jumbao),
    SPECIES_SPRITE(PAJANTOM, gMonFrontPic_Pajantom),
