...
#endif
    SPECIES_PAL(STRATAGEM, gMonPalette_Stratagem),
    SPECIES_PAL(VOODOOM, gMonPalette_Voodoom),
    SPECIES_PAL(CARIBOLT, gMonPalette_Caribolt),
    SPECIES_PAL(COLOSSOIL, gMonPalette_Colossoil),
    SPECIES_PAL(CYCLOHM, gMonPalette_Cyclohm),
    SPECIES_PAL(FIDGIT, gMonPalette_Fidgit),
    SPECIES_PAL(KITSUNOH, gMonPalette_Kitsunoh),
    SPECIES_PAL(MALACONDA, gMonPalette_Malaconda),
    SPECIES_PAL(MIASMAW, gMonPalette_Miasmaw),
    SPECIES_PAL(SNAELSTROM, gMonPalette_Snaelstrom),
    SPECIES_PAL(SYCLANT, gMonPalette_Syclant),
    SPECIES_PAL(TOMOHAWK, gMonPalette_Tomohawk),
    SPECIES_PAL(REVENANKH, gMonPalette_Revenankh),
    SPECIES_PAL(KRILOWATT, gMonPalette_Krilowatt),
    SPECIES_PAL(CRUCIBELLE, gMonPalette_Crucibelle),
    SPECIES_PAL(MOLLUX, gMonPalette_Mollux),
    SPECIES_PAL(EQUILIBRA, gMonPalette_Equilibra),
    SPECIES_PAL(NAVIATHAN, gMonPalette_Naviathan),
    SPECIES_PAL(KERFLUFFLE, gMonPalette_Kerfluffle),
    SPECIES_PAL(JUMBAO, gMonPalette_Jumbao),
    SPECIES_PAL(PAJANTOM, gMonPalette_Pajantom),
