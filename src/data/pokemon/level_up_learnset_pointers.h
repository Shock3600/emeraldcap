const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_EQUILIBRA] = sEquilibraLevelUpLearnset,
    [SPECIES_MOLLUX] = sMolluxLevelUpLearnset,
    [SPECIES_CRUCIBELLE] = sCrucibelleLevelUpLearnset,
    [SPECIES_KRILOWATT] = sKrilowattLevelUpLearnset,
    [SPECIES_REVENANKH] = sRevenankhLevelUpLearnset,
    [SPECIES_TOMOHAWK] = sTomohawkLevelUpLearnset,
    [SPECIES_SYCLANT] = sSyclantLevelUpLearnset,
    [SPECIES_SNAELSTROM] = sSnaelstromLevelUpLearnset,
    [SPECIES_MIASMAW] = sMiasmawLevelUpLearnset,
    [SPECIES_MALACONDA] = sMalacondaLevelUpLearnset,
    [SPECIES_KITSUNOH] = sKitsunohLevelUpLearnset,
    [SPECIES_FIDGIT] = sFidgitLevelUpLearnset,
    [SPECIES_CYCLOHM] = sCyclohmLevelUpLearnset,
    [SPECIES_COLOSSOIL] = sColossoilLevelUpLearnset,
    [SPECIES_CARIBOLT] = sCariboltLevelUpLearnset,
    [SPECIES_VOODOOM] = sVoodoomLevelUpLearnset,
    [SPECIES_STRATAGEM] = sStratagemLevelUpLearnset,
