const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
...
#endif
    [SPECIES_STRATAGEM]             = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    ...
    [SPECIES_FIDGIT]                = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    [SPECIES_KITSUNOH]              = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    [SPECIES_MALACONDA]             = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    [SPECIES_MIASMAW]               = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    [SPECIES_SNAELSTROM]            = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    [SPECIES_SYCLANT]               = {{EVO_LEVEL, 20, SPECIES_BULBASAUR},
},
    [SPECIES_TOMOHAWK]              = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    [SPECIES_REVENANKH]             = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    [SPECIES_KRILOWATT]             = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    [SPECIES_CRUCIBELLE]            = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    [SPECIES_MOLLUX]                = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    ...
    [SPECIES_JUMBAO]                = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
    [SPECIES_PAJANTOM]              = {{EVO_LEVEL, 1, SPECIES_BULBASAUR},
},
};
